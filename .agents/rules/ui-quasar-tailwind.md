...
- **SEMPRE** utilize os componentes nativos do Quasar como superfícies base:
  - Utilize `<q-card>` para painéis. O `<q-card>` reage perfeitamente ao _Dark Mode_ do motor do Quasar e altera para a cor apropriada sem precisar de classes Tailwind.
