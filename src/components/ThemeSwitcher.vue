...
<template>
  <div class="tw-flex tw-items-center">
    ...
    <q-btn-dropdown flat dense color="white" icon="palette" class="tw-mr-2" aria-label="Selecionar Marca">
      <q-list>
    ...
    <q-btn flat round dense :icon="themeStore.activeMode === 'dark' ? 'dark_mode' : themeStore.activeMode === 'light' ? 'light_mode' : 'brightness_auto'" @click="toggleMode" color="white" aria-label="Alternar Iluminação">
